...
# PyCraft version 1.1.10 experimental snapshot [MODER EDITION] zh-CN
# PyCraft is not for sale.
# If you purchased PyCraft, please report the seller.
# Version: v1.1.10 experimental-snapshot [MODER EDITION]
# Author: Owen171400 (3381443064@qq.com)
# Updated: Fixed issues about mod installation. Status bar will be distributed on version 1.1.3.
...
# Fixed: Known 77 issues, such as LoadingError(EXCE009).
# ****************************************************************************
# Peek:
# Version v1.2.0 beta: Developer added more fun sources!
# MODER: Version 1.0, api=1.0.9
# ****************************************************************************
...
imported = ['Inslider-Flask','Status-Bar']
unable = []
name = None
place = 'default'
jy = 0
...
def do():
    global jy, nd, dig, hunger, place, name, toolcase, ABQuery, Compass, foodpack
    while True:
